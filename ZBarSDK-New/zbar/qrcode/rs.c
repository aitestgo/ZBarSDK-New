...
//    int           nerrors;
//    int           i;
//    ndata=arc4random()&0xFF;
//    npar=ndata>0?arc4random()%ndata:0;
//    for(i=0;i<ndata-npar;i++)data[i]=arc4random()&0xFF;
...
//          unsigned char e;
//          int           ei;
//          ei=arc4random()%(ndata-i)+i;
//          e=epos[ei];
//          epos[ei]=epos[i];
//          epos[i]=e;
//          data[e]^=arc4random()%255+1;
//        }
